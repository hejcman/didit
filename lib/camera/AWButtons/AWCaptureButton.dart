...
class AWCaptureButton extends StatefulWidget {
  final CameraState state;

  const AWCaptureButton({
    super.key,
    required this.state,
  });

  @override
  _AWButtonState createState() => _AWButtonState();
}

class _AWButtonState extends State<AWCaptureButton>
