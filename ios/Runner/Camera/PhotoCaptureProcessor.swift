...
class PhotoCaptureProcessor: NSObject {
    ...
    var photoData: Data? // The actual captured photo's data
    private var maxPhotoProcessingTime: CMTime? // The maximum time lapse before telling UI to show a spinner
